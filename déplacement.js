...
var isDragging = false; // Indicateur de glissement
var offsetX, offsetY; // Offset pour garder la position relative de la souris par rapport au carré
var mouseX = 0; // Variable pour stocker la position X de la souris
var mouseY = 0; // Variable pour stocker la position Y de la souris
...
//     isDragging(event.clientX - offsetX,event.clientY - offsetY)}};
